...
(function () {
  ...
  function syncActivePanelUI(activeIndex) {
    // 1. Actualizar botones de progreso y aria-current
    ...
    // 2. Actualizar paneles (clase activa)
    ...
    // 3. Actualizar botones Anterior / Siguiente
    if (state.prevBtn) {
    ...
    // 4. Gestión de foco e inercia para evitar trampas de accesibilidad en paneles fuera de pantalla
    updatePanelInert(activeIndex);
  }
